...
def process_reward_data(
    ...
    if save_figs:
        plt.savefig(reward_data.reward_plots_dir / (run_ID[1][4:] + "_" + log_component + "_rewards_plot.png"))
        plt.savefig(reward_data.reward_plots_dir / (run_ID[1][4:] + "_" + log_component + "_rewards_plot.eps"), format="eps")
